...
class Simulacion:
    ...
    def nuevo_dia(self) -> None:
        recolector1 = Recolector(nombre="1", centro_urbano=self.centro_urbano) 
        recolector2 = Recolector(nombre="2", centro_urbano=self.centro_urbano) 
        trabajador1 = Constructor(nombre="1", centro_urbano=self.centro_urbano) 
        trabajador2 = Constructor(nombre="2", centro_urbano=self.centro_urbano) 
