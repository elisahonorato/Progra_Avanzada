...
class Mapa:
    ...
    def crear_habitacion(self, id, nombre, id_vecinos, objetos): # COMPLETAR
        ...
        habitacion_creada = Habitacion(id, nombre, id_vecinos, objetos)
        self.habitaciones_creadas.append(habitacion_creada)
    ...
    def registrar_vecino(self, habitacion: Habitacion, vecino: Habitacion): # COMPLETAR
        ...
        if vecino.id in habitacion.id_vecinos and vecino not in habitacion.conexiones:
    ...
    def descartar_habitacion(self, habitacion: Habitacion): # COMPLETAR
        ...
        for habitacion_vecina in habitacion.conexiones:
            habitacion_vecina.conexiones.remove(habitacion)
