...
from atracciones import Atraccion, GranjaHerbivoros, PaseoCarnivoros
...
class DCCentralZoo:
    ...
    def __init__(self, semanas_maximas: int):
        self.semana = 0
    ...
    def calcular_estadisticas(self) -> tuple:
        atraccion = Atraccion
        for atraccion in self.atracciones_herbivoros:
            return (atraccion.visitantes, atraccion.recaudacion)
            
        for atracciones in self.atracciones_herbivoros:
            
            visitantes_totales = 0
            recaudacion_total = atracciones.recaudacion_total
            return (visitantes_totales, recaudacion_total)
